  ...
  return (
    ...
    <Guide>
        ...
        <Container>
          ...
          <Img fluid={data.allFile.edges[0].node.childImageSharp.fluid} alt=" " />
          ...
          <Img fluid={data.allFile.edges[1].node.childImageSharp.fluid} alt=" " />
          ...
          <Img fluid={data.allFile.edges[2].node.childImageSharp.fluid} alt=" " />

          <Upnext>Up next: <Link to="../chapter2">Fundamental features of Ably &rarr;</Link></Upnext>
        </Container>
    </Guide>
  </Layout>
  )
